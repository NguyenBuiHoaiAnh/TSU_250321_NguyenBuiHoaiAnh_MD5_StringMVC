...
<body>
<h1>Add Update Schedule</h1>
<div class="form-container">
    <form action="<%=request.getContextPath()%>/ScheduleServlet?action=Update" method="post">
        <label for="id">ID</label>
        <input type="text" id="id" name="id" value="${schedule.id}" readonly/><br>
